    ...
    * */
    themeConfig: {
        ...
        * */
        ...
        //定制首页随机一言文字
        customRandomValue: 'jqc i love u ',
        ...
        about: [
            {
                ...
                describe: [
                    "啥也不会的社畜",
                    "大二学生,网络安全专业,坐标南京浦口",
                    "喜欢安静,不喜社交，最喜欢和最喜欢的人呆在一起",
                    "喜欢听音乐,ずっと真夜中でいいのに yyds好吧",
                    "喜欢技术,特别是能搞些小破坏的技能",
                    "目前正在学习渗透，前端开发",
                    "主题是借鉴别人的，如果有可能当然希望开发一个自己的主题",
                    "懒癌晚期",
                    "除了吃好吃的外没有什么兴趣爱好",
                    "2.5次元，原先挺喜欢看番，但是现在没有原先那么积极了",
                    "现在在看《这么多年》，小说比电影好看多了",
                ],
                // tag: [
                //     "？？？",
        ...
        * */
        ...
        //网站开始时间，请按照以下格式进行
        startRunTime: "9/2/2018 12:00:00",

        //网站运行时间前缀
        prefixRuntime: "重要的事已经发生",
        ...
        poster: {
            //博客描述
            description: "啥也不会的reicalg分享他的一些无用知识",
        ...
        //侧边栏配置
        //github地址
        githubUrl: "https://github.com/reiclag2003/",
